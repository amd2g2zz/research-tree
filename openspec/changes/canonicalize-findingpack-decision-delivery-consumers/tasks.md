...
- [x] 2.4 Keep assurance, export, and retained readiness on an isolated test-only
  legacy-runtime fixture until #181; do not add a shim, dual store, or
  production change.

## 3. Verification And Queue Handoff

- [x] 3.1 Run focused and relevant full regression tests plus `ruff`.
- [x] 3.2 Run strict OpenSpec, governance, package, and delivery validation.
- [x] 3.3 After #175's queue is merged, rebase and record the required
