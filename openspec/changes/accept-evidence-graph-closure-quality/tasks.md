...
- [x] 1.1 Register group 39 and issue #152 with exact group-46/group-47
  dependencies and rollback semantics.
- [x] 1.2 Add a focused regression for missing, malformed, and unreachable
